...
const CreateNFT = () => {
  ...
  if (isLoadingNFT) {
    window.scrollTo(0, 0);
    return (
      <div className="w-full flexCenter flex-col min-h-screen">
        <h1 className="font-poppins dark:text-white text-nft-black-1 font-extrabold text-3xl">We are minting your NFT, it can take a few minutes...</h1>
        <Loader />
      </div>
    );
  }
              ...
              <aside>
                <div className="flexCenter mt-10">
                  <img
                    src={fileUrl}
                    alt="asset_file"
                    className="border-nft-black-2 border"
                  />
                </div>
              </aside>
            )}
