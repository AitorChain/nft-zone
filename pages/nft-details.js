      ...
      <div className="flex-1 justify-start sm:px-4 p-12 sm:pb-4">
        ...
        <div className="mt-10 flex flex-col">
          <div className="w-full border-b dark:border-nft-black-1 border-nft-gray-1 flex flex-row">
            <p className="font-poppins dark:text-white text-nft-black-1 text-base mb-2 font-medium">Details</p>
          </div>
          <div className="mt-3">
            <p className="font-poppins dark:text-white text-nft-black-1 font-normal">{nft.description}</p>
          </div>
        </div>
            ...
            ? (
              ...
              ? (
                ...
                <Button
                  ...
                  classStyles="mr-5 sm:mr-0 sm:mb-5 rounded-xl"
                  handleClick={() => (window.ethereum ? setPaymentModal(true) : alert('You need to install Metamask to buy this NFT'))}
                />
              )}
        </div>
      </div>
